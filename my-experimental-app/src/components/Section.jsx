    ...
    <div className="section">
      ...
      <div className="card-grid">
        ...
        <CardHero 
          ...
          text="Acropolis and Cyclades Islands Tour"
          buttonText="Book now"
        />
        <CardHero 
          ...
          title="Japan" 
          text="Experience Tokyo's temples and modernity."
          buttonText="Discover the tour now"
        />
        <CardHero 
          ...
          title="Maldives" 
          text="Relax in a bungalow on the crystal clear water."
          buttonText="Choose the offer now"
        />
        ...
        <CardHero 
          ...
          title="Italy" 
          text="Rome, Venice, and Florence in a unique tour."
        ...
        <CardHero 
          ...
          title="Thailand" 
          text="Between Buddhist temples and dream beaches."
          buttonText="Book now"
        />
        <CardHero 
          ...
          title="Norway" 
          text="Northern Lights and breathtaking fjords."
